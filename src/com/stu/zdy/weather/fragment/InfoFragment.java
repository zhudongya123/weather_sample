...
@SuppressLint("InflateParams") public class InfoFragment extends Fragment {
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		TextView textView3 = (TextView) getActivity().findViewById(
				R.id.textview3);
		String string = "<p>��������ͼ������:<a href=\"http://azuresol.deviantart.com\">AzureSol</a>";
		string = string
		...
		string = string
				+ "<p>��Դ�ؼ�:MaterialDialog  <a href=\"https://github.com/drakeet\">GitHub</a></p>";
		string = string
				+ "<p>��Դ�ؼ�:Ldrawer  <a href=\"https://github.com/keklikhasan/LDrawer\">GitHub</a></p>";
		string = string
				+ "<p>��Դ�ؼ�:FloatingActionButton  <a href=\"https://github.com/makovkastar/FloatingActionButton\">GitHub</a></p>";
		string = string
				+ "<p>��Դ�ؼ�:materialish-progress-master  <a href=\"https://github.com/pnikosis/materialish-progress\">GitHub</a></p>";
		string = string
				+ "<p>Java��������:json-lib  <a href=\"http://json-lib.sourceforge.net\">��վ</a></p>";
		string = string + "<p>������ƬΪ�������㣬LoGoΪ���˶��δ���</p>";
