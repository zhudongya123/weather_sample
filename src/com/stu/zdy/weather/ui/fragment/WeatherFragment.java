...
public class WeatherFragment extends Fragment {
	...
	public void updataView(Bundle bundle) {
		...
		int j = 0;
		SharedPreferences sharedPreferences = getActivity().getSharedPreferences("weather_info", Context.MODE_PRIVATE);
		...
		case 102:
		case 103:
			weatherPicture.setImageDrawable(getResources().getDrawable(R.drawable.sunny));
			break;
		case 101:
			weatherPicture.setImageDrawable(getResources().getDrawable(R.drawable.cloudy));
			break;
		case 104:
			weatherPicture.setImageDrawable(getResources().getDrawable(R.drawable.overcast));
			break;
		case 300:
		case 301:
		case 302:
		...
		case 312:
		case 313:
			weatherPicture.setImageDrawable(getResources().getDrawable(R.drawable.rain));
			break;
		case 400:
		case 401:
		case 402:
		...
		case 406:
		case 407:
			weatherPicture.setImageDrawable(getResources().getDrawable(R.drawable.snow));
			break;
		case 500:
		case 501:
		case 502:
			weatherPicture.setImageDrawable(getResources().getDrawable(R.drawable.fog));
			break;
		}
