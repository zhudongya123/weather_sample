package com.stu.zdy.weather.open_source;
...
public class MaterialDialog {
	...
	public String getText() {
		return mBuilder.getText();

	}

	public MaterialDialog setText(int resId) {
		mEditTextResId = resId;
		if (mBuilder != null) {
			mBuilder.setText(resId);
		}
		return this;
	}

	public MaterialDialog setText(CharSequence text) {
		mText = text;
		if (mBuilder != null) {
	...
	private class Builder {
		...
		private Builder() {
			...
			View contv = LayoutInflater.from(mContext).inflate(
					R.layout.dialog_layout_material, null);
			...
			mEditText = (EditText) mAlertDialogWindow.findViewById(R.id.text);
